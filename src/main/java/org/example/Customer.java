...
public class Customer extends User implements Reviewable {
     ...
     */
    @Override
    public boolean submitReview(String productId, int userId, Review.StarRating rating, String text) {
        return ReviewManager.submitReviewHelper(productId, userId, rating, text);
    }
}
